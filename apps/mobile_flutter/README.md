...
class EnvConfig {
  ...
  static const String OPENWEATHERMAP_API_FORECAST = '/data/2.5/forecast/daily';
  static const String OPENWEATHERMAP_API_DAILY_FORECAST_PATH = '$OPENWEATHERMAP_API_FORECAST/daily';
