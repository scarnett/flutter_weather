  ...
  group('Add location', () {
    testWidgets('Should add a location', (
      ...
      await binding.traceAction(() async {
        ...
        Finder locationPostalCodeField = find.byKey(Key(AppKeys.locationPostalCodeKey));
        ...
        Finder locationCountryField = find.byKey(Key(AppKeys.locationCountryKey));
        ...
        Finder locationCountryFilterField = find.byKey(Key(AppKeys.locationCountryFilterKey));
        ...
        // Find the 'lookup' button
        Finder lookupLocationButton = find.byKey(Key(AppKeys.locationLookupButtonKey));
        ...
        Finder addThisForecastButton = find.byKey(Key(AppKeys.addThisForecastKey));
